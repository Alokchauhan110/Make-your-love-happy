...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    welcome_message = (
        ...
        "I'll help you create a beautiful, animated webpage for your special someone by asking a series of questions.\n\n"
        "✨ **Check out a demo here:** [Your Demo Website Link]\n\n"
...
async def get_gf_name(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
...
def run_bot() -> None:
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            ...
            GET_MEMORY1_TITLE: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_memory1_title)],
            GET_MEMORY1_DESC: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_memory1_desc)],
            GET_MEMORY2_PHOTO: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_memory2_photo)],
            GET_MEMORY2_TITLE: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_memory2_title)],
            GET_MEMORY2_DESC: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_memory2_desc)],
            GET_GALLERY_1: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_gallery_1)],
            GET_GALLERY_2: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_gallery_2)],
            GET_GALLERY_3: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_gallery_3)],
            GET_GALLERY_4: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_gallery_4)],
            GET_GALLERY_5: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_gallery_5)],
            GET_GALLERY_6: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_gallery_6)],
            GET_COUNTDOWN_OCCASION: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_countdown_occasion)],
            GET_COUNTDOWN_DATE: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_countdown_date)],
            GET_FINAL_HEADING: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_final_heading)],
            GET_FINAL_MESSAGE: [MessageHandler(filters.TEXT & ~filters.COMMAND, get_final_message)],
        },
